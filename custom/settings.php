<?
    ...
    //Custom code
    $bigtree["config"]["admin_css"] = array('terra-it_bigtree_skin.css'); // Additional CSS Files For the Admin to load, relative to /custom/admin/css/
    $bigtree["config"]["admin_js"] = array('terra-it_bigtree_skin.js'); // Additional JavaScript Files For the Admin to load, relative to /custom/admin/js/
